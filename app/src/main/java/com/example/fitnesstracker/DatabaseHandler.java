...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // database fields
    private static final int DATABASE_VERSION = 7; // database version, 1: initial, 2: incl. weight
    public static final String DATABASE_NAME = "calorieTracker"; // database name
    ...
    private static final String MEALS_KEY_fat = "fat";
    ...
    public int addMeal(Meal meal) {
        ...
        if (meal.getfat() != 0.0) values.put(MEALS_KEY_fat, meal.getfat());
        ...
        if (dateID != -1) { // if date doesn't exist return empty list otherwise get to doing stuff
            ...
            if (c.moveToFirst()) {
                do {
                    ...
                    if (!c.isNull(7)) m.setfat(c.getDouble(7));
                    meals.add(m);
                } while (c.moveToNext());
            }
